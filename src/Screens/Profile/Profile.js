...
class Profile extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      colors: [
        { id: 1, colorId: colors.themeColor2 },
        { id: 2, colorId: colors.themeColor },
        { id: 3, colorId: colors.green1},
        { id: 4, colorId: colors.blue},
      ],
    };
  }
      ...
      <View style={styles.container}>
        ...
        <ScrollView>
          <View
            ...
            />
            <Text style={styles.userNameText}>Saloni Bhatia</Text>
          </View>
            ...
            <View style={styles.subListView2}>
              <View style={styles.subList}>
                <Image
                  ...
                  source={imagePath.leftArrow}
                />
                <Text style={styles.listText}>Test Bookings</Text>
              </View>
            </View>
          </View>
            ...
            <View style={styles.subListView3}>
              <View style={styles.subList}>
                <Image
                  ...
                  source={imagePath.leftArrow}
                />
                <Text style={styles.listText}>Payments & HealthCash</Text>
              </View>
            </View>
          </View>
